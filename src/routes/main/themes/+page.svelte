                          ...
                          {#if colorInfo}
                            <SettingsColorAlpha
                              ...
                              value={SETTINGS.accessibility.state
                                .customThemeColors?.[colorKey as keyof typeof DEFAULT_CUSTOM_THEME_COLORS] ??
                                DEFAULT_CUSTOM_THEME_COLORS[colorKey as keyof typeof DEFAULT_CUSTOM_THEME_COLORS] ??
                                "rgba(128, 128, 128, 1)"}
            ...
            <div class="px-4 pb-4 space-y-4">
              ...
              <div class="space-y-4 pt-2 border-t border-border/50">
                ...
                <div class="space-y-2 pt-3 border-t border-border/30">
                  ...
                  <SettingsSwitch
                    bind:checked={
                      SETTINGS.live.headerCustomization.state.showPinButton
                    }
                    label="Show Pin Button"
                    description="Button to pin or unpin the live meter"
                  />
                  {#if SETTINGS.live.headerCustomization.state.showPinButton}
                    <div class="grid grid-cols-2 gap-2 pl-4">
                      <SettingsSlider
                        bind:value={
                          SETTINGS.live.headerCustomization.state.pinButtonSize
                        }
                        min={12}
                        max={32}
                        step={1}
                      ...
                      <SettingsSlider
                        bind:value={
                          SETTINGS.live.headerCustomization.state.pinButtonPadding
                        }
                        min={2}
                        max={16}
                        step={1}
