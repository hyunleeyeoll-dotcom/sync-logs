<script lang="ts">
  ...
  let inputs: BaseInputs = [
    ...
    {
      id: "showPlayerOverlay",
      label: "Show Player Overlay",
    },
    {
      id: "hidePlayerOverlay",
      label: "Hide Player Overlay",
    },
    {
      id: "togglePlayerOverlay",
      label: "Toggle Player Overlay",
    },
    {
    ...
    {
      id: "toggleOverlayClickthrough",
      label: "Toggle Overlay Clickthrough",
    },
    {
      id: "resetEncounter",
