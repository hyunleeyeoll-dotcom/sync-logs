  ...
  <nav class="bg-card/50 rounded-lg border border-border/50 shrink-0">
    <div class="flex items-center justify-between px-4 py-2.5">
      ...
      <div class="flex items-center gap-2 text-muted-foreground shrink-0">
        <div class="inline-flex items-center gap-2 rounded-full border border-border/60 bg-popover/40 px-3 py-1.5 text-xs uppercase tracking-[0.24em] text-muted-foreground">
