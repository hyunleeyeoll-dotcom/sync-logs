...
<div class="space-y-4">
  ...
  >
    ...
    <p class="text-sm text-muted-foreground">
      Configure sync credentials here when your replacement backend is ready.
      This panel handles credentials, background sync preferences, and API
      checks while the server integration continues to settle.
    </p>
  </div>
  ...
  >
    <div class="flex items-start justify-between gap-4">
      <div>
        ...
        <p class="text-sm text-muted-foreground">
          How Sync uploads are currently wired
        </p>
      </div>
      <button
    ...
    {#if showGuide}
      ...
      >
        ...
        <ol class="list-decimal pl-4 space-y-2">
          <li>
            <strong>Server integration is still being finalized.</strong>
            Verify the configured endpoint before treating uploads as production-ready.
          </li>
          <li>
            <strong>Paste credentials below and click Save.</strong> Nothing is uploaded until
            a saved key exists, including background tasks.
          </li>
          <li>
            <strong>Click Start upload</strong> to push any existing local logs
            to the currently configured service.
          </li>
          <li>
            <strong>Uploads happen in the background:</strong> once a saved key
            exists, the app can continue syncing automatically.
          </li>
          <li>
  ...
  >
    <div class="flex items-center justify-between">
      ...
      <div class="relative">
        ...
        >
          <span>View Logs</span>
          <span class="text-[10px]">{showLogsDropdown ? "^" : "v"}</span>
        </button>
