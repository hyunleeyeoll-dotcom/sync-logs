...
const DEFAULT_GENERAL_SETTINGS = {
  ...
  showSeasonStrengthInMeters: false,
  showBattleImaginesInMeters: false,
...
export const DEFAULT_CUSTOM_THEME_COLORS = {
  ...
  playerOverlayWindow: 'rgba(33, 33, 33, 0.9)',
...
export type CustomThemeColors = {
  [K in keyof typeof DEFAULT_CUSTOM_THEME_COLORS]: string;
};
...
export const CUSTOM_THEME_COLOR_LABELS: Record<string, { label: string; description: string; category: string }> = {
  ...
  playerOverlayWindow: { label: 'Player Overlay Background', description: 'Background color for the player overlay window', category: 'Utility' },
...
const DEFAULT_SETTINGS = {
  ...
  live: {
    ...
    playerOverlay: {
      visible: false,
      clickthrough: false,
      metricType: 'dps' as 'dps' | 'heal' | 'tanked',
      maxRows: 5,
    },
  },
  history: {
...
export const SETTINGS = {
  ...
  live: {
    ...
    playerOverlay: new RuneStore(
      'livePlayerOverlay',
      DEFAULT_SETTINGS.live.playerOverlay,
      RUNE_STORE_OPTIONS
    ),
...
export const settings = {
  state: {
    ...
    live: {
      ...
      playerOverlay: SETTINGS.live.playerOverlay.state,
      columnOrder: {
